...
//NOTE: These are overridden for this version of lib
KP_liberation_guerilla_units = ["OPTRE_FC_Elite_MinorAA_IND", "OPTRE_FC_Elite_MinorAT_IND", "OPTRE_FC_Elite_Minor_IND", "OPTRE_FC_Elite_Minor2_IND"];
